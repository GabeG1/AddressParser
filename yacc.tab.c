...
union YYSTYPE
{
#line 24 "yacc.y" /* yacc.c:355  */

   char* str;
   int i;

#line 132 "yacc.tab.c" /* yacc.c:355  */
};
...
{
       0,    54,    54,    55,    57,    59,    62,    66,    73,    83,
      95,   105,   113,   121,   129,   138,   147,   151,   158,   169,
     180,   189,   193,   201,   213,   224,   238
};
#endif
...
{
  "$end", "error", "$undefined", "NAMETOKEN", "IDENTIFIERTOKEN",
  "NAME_INITIAL_TOKEN", "ROMANTOKEN", "SRTOKEN", "JRTOKEN", "EOLTOKEN",
  "INTTOKEN", "COMMATOKEN", "DASHTOKEN", "HASHTOKEN", "$accept",
  "postaladdresses", "addressblock", "namepart", "personalpart",
  "lastname", "suffixpart", "streetaddress", "streetnumber", "streetname",
  "locationpart", "townname", "statecode", "zipcode", YY_NULLPTR
};
#endif
...
{
       1,    -8,    -9,    -9,     5,     8,    -1,     7,    -9,    -9,
       1,    10,    -9,    -9,    15,    17,    -9,     6,    -9,    -9,
      12,    -9,    -9,    11,    -9,    -2,    -9,    -9,    -9,    -9,
      14,    -9,    21,    -9,    16,    18,    -9,    -9,    19,    -9,
      22,    20,    24,    -9,    25,    -9,    -9
};
...
{
      11,     8,     1,    12,     2,     9,     3,    33,    34,    13,
      16,    35,    26,    27,    28,    29,    20,    10,    21,    19,
      24,    31,    32,    36,    37,    39,     0,     0,    40,    41,
       0,    43,    44,    45,     0,    46,    18
};

static const yytype_int8 yycheck[] =
{
       1,     9,     1,     4,     3,     0,     5,     9,    10,    10,
       3,    13,     6,     7,     8,     9,     1,     9,     3,     9,
       3,     9,    11,     9,     3,     9,    -1,    -1,    10,    10,
      -1,     9,    12,     9,    -1,    10,    10
};
...
{
       0,     1,     3,     5,    15,    16,    17,    18,     9,     0,
       9,     1,     4,    10,    21,    22,     3,    19,    15,     9,
       1,     3,    24,    25,     3,    23,     6,     7,     8,     9,
      20,     9,    11,     9,    10,    13,     9,     3,    26,     9,
      10,    10,    27,     9,    12,     9,    10
};
...
#line 1256 "yacc.tab.c" /* yacc.c:1646  */
    break;
